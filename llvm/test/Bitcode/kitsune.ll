; Check that the bitcode reader and writer can handle Kitsune-specific types,
; types etc.
;
; RUN: llvm-as %s -o - \
; RUN:     | llvm-dis -o - \
; RUN:     | FileCheck %s
;
; COM: CHECK-DAG: @.kitsunc.bc = {{.+}} #[[BC:[0-9]+]]
; COM: CHECK-DAG: @.kitsune.fb = {{.+}} #[[FB:[0-9]+]]
; CHECK-DAG: @.kitsune.kernel.props = {{.+}} #[[PROPS:[0-9]+]]
