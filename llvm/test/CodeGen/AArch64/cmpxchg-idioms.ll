...
; RUN: llc -mtriple=aarch64-apple-ios7.0 -aarch64-enable-sink-fold=true -tail-dup-cbz=0 -o - %s | FileCheck %s
; RUN: llc -mtriple=aarch64-apple-ios7.0 -mattr=+outline-atomics -aarch64-enable-sink-fold=true -tail-dup-cbz=0 -o - %s | FileCheck %s --check-prefix=OUTLINE-ATOMICS
