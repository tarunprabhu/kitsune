...
; CHECK: define internal fastcc void @cilk_merge_det.achd.tapir(i64* align 1 %source_1.tr.tapir, i64 %div.tapir, i64* align 1 %source_2.tr.tapir, i64 %add9.tapir, i64*
; CHECK-NOT: returned
; CHECK: %target.tapir) local_unnamed_addr
