...
;
; RUN: opt < %s -passes="tapir-lowering<O2>" -tapir-target=opencilk -use-opencilk-runtime-bc=false --tapir-opencilk-runtime-bc=%S/libopencilk-abi.bc -debug-abi-calls -kit-no-verify-prelower -S | FileCheck %s
