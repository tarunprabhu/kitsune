...
;
; RUN: opt < %s -passes="function(loop-simplify),loop-spawning" -tapir-target=opencilk -S | FileCheck %s
...
!5 = !{!"Simple C++ TBAA"}
!6 = !{!4, !4, i64 0}
!7 = distinct !{!7, !8, !14, !15}
!8 = !{!"tapir.loop.spawn.strategy", i32 2}
!9 = distinct !{!9, !8, !14, !15}
!10 = distinct !{!10, !8, !14, !15}
!11 = distinct !{!11, !8, !14, !15}
!12 = distinct !{!12, !8, !14, !15}
!13 = distinct !{!13, !8, !14, !15}
!14 = !{!"tapir.loop.target", i32 8}
!15 = !{!"tapir.loop.lowering.enabled"}
