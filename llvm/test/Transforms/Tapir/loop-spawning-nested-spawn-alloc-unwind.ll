...
;
; RUN: opt < %s --tapir-target=opencilk -passes="loop-spawning,task-simplify" -S | FileCheck %s
...
!475 = distinct !{!475, !458, !471, !472, !476, !473, !477, !556, !557}
!476 = !{!"tapir.loop.spawn.strategy", i32 2}
...
!547 = distinct !{!547, !451, !548, !472, !476, !477, !556, !557}
...
!555 = !{!142, !17, !162}
!556 = !{!"tapir.loop.target", i32 8}
!557 = !{!"tapir.loop.lowering.enabled"}
