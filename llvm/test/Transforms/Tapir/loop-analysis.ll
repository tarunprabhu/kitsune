; RUN: opt < %s -enable-new-pm=0 -loop-stripmine -stripmine-loops -disable-output -pass-remarks-analysis=loop-stripmine 2>&1 | FileCheck %s
; RUN: opt < %s -passes='loop-stripmine' -stripmine-loops -disable-output -pass-remarks-analysis=loop-stripmine 2>&1 | FileCheck %s
