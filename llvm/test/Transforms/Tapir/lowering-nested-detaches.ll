...
define dso_local void @kernel_anon([24 x [21 x [33 x float]]]* noalias nocapture nonnull readonly %A, [24 x float]* noalias nocapture nonnull readonly %B, [24 x float]* noalias nocapture nonnull readonly %C, [24 x float]* noalias nocapture nonnull readonly %D, [24 x float]* noalias nocapture nonnull %O1) local_unnamed_addr #0 {
entry:
