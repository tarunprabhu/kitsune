...
; CHECK-NEXT:    [[TMP52:%.*]] = add nsw <16 x i32> [[TMP51]], [[TMP50]]
; CHECK-NEXT:    [[TMP53:%.*]] = sub nsw <16 x i32> [[TMP50]], [[TMP51]]
; CHECK-NEXT:    [[TMP54:%.*]] = shufflevector <16 x i32> [[TMP52]], <16 x i32> [[TMP53]], <16 x i32> <i32 1, i32 3, i32 5, i32 7, i32 17, i32 19, i32 21, i32 23, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP55:%.*]] = shufflevector <16 x i32> [[TMP52]], <16 x i32> [[TMP53]], <16 x i32> <i32 0, i32 2, i32 4, i32 6, i32 16, i32 18, i32 20, i32 22, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP56:%.*]] = sub nsw <16 x i32> [[TMP55]], [[TMP54]]
...
; CHECK-NEXT:    [[TMP60:%.*]] = add nsw <16 x i32> [[TMP59]], [[TMP58]]
; CHECK-NEXT:    [[TMP61:%.*]] = sub nsw <16 x i32> [[TMP58]], [[TMP59]]
; CHECK-NEXT:    [[TMP62:%.*]] = shufflevector <16 x i32> [[TMP60]], <16 x i32> [[TMP61]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
; CHECK-NEXT:    [[TMP63:%.*]] = lshr <16 x i32> [[TMP62]], splat (i32 15)
; CHECK-NEXT:    [[TMP64:%.*]] = and <16 x i32> [[TMP63]], splat (i32 65537)
; CHECK-NEXT:    [[TMP65:%.*]] = mul nuw <16 x i32> [[TMP64]], splat (i32 65535)
; CHECK-NEXT:    [[TMP66:%.*]] = add <16 x i32> [[TMP65]], [[TMP62]]
; CHECK-NEXT:    [[TMP67:%.*]] = xor <16 x i32> [[TMP66]], [[TMP65]]
; CHECK-NEXT:    [[TMP74:%.*]] = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> [[TMP67]])
