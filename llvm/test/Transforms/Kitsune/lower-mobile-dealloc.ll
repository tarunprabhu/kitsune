...
define dso_local void @deallocate(ptr nocapture noundef readnone %ptr) local_unnamed_addr #0 {
entry:
  tail call void @llvm.kitsune.mobile.free(ptr %ptr)
  ret void
}

; Function Attrs: mustprogress nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite)
declare void @llvm.kitsune.mobile.free(ptr nocapture readnone) #1
