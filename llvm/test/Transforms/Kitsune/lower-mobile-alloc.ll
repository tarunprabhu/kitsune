...
define dso_local noalias ptr @allocate(i64 noundef %n) local_unnamed_addr #0 {
entry:
  %mul = shl i64 %n, 2
  %0 = tail call noalias ptr @llvm.kitsune.mobile.alloc(i64 %mul)
  ret ptr %0
}

; Function Attrs: nounwind memory(inaccessiblemem: readwrite)
declare noalias ptr @llvm.kitsune.mobile.alloc(i64) #1
...
; SERIAL: call noalias ptr @__kitrt_default_mem_alloc(i64 %mul)
; SERIAL-NOT: call .+ llvm.kitsune.mobile.alloc
; SERIAL-DAG: declare noalias ptr @__kitrt_default_mem_alloc(i64)

; NONE-LABEL: @allocate
; NONE: call noalias ptr @llvm.kitsune.mobile.alloc
