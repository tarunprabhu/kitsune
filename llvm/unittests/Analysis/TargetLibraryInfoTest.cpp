...
TEST_F(TargetLibraryInfoTest, ValidProto) {
  parseAssembly(
      ...
      "declare i32 @__kitocilk_num_workers()\n"
      "declare i64 @__kitocilk_reduce_num_partials(i64)\n"
      "declare void @__kitomp_finalize()\n"
      "declare void @__kitomp_initialize()\n"
      "declare void @__kitomp_launch(ptr, i64, i64, i64, ptr)\n"
      "declare i32 @__kitomp_num_threads()\n"
      ...
      "declare i32 @__kitpthr_num_threads()\n"
      ...
      "declare void @__kitqthr_launch(ptr, i64, i64, i64, ptr)\n"
      "declare i32 @__kitqthr_num_workers()\n"
