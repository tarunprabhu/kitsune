...
TEST_F(TargetLibraryInfoTest, ValidProto) {
  parseAssembly(
      ...
      "declare void @__kitcuda_finalize()\n"
      "declare ptr @__kitcuda_get_global_symbol(ptr, ptr)\n"
      "declare ptr @__kitcuda_get_thread_stream()\n"
      "declare void @__kitcuda_initialize()\n"
      "declare ptr @__kitcuda_launch_kernel(ptr, ptr, ptr, i64, i64, i64, i32, ptr, ptr)\n"
      "declare ptr @__kitcuda_mem_alloc_managed(i64)\n"
      "declare void @__kitcuda_mem_free(ptr)\n"
      "declare ptr @__kitcuda_mem_gpu_prefetch(ptr, i64, ptr)\n"
      "declare ptr @__kitcuda_mem_host_prefetch(ptr, i64, ptr)\n"
      "declare void @__kitcuda_memcpy_sym_to_device(ptr, ptr, i64)\n"
      "declare void @__kitcuda_memcpy_sym_to_host(ptr, ptr, i64)\n"
      "declare i64 @__kitcuda_reduce_num_partials(i64)\n"
      "declare ptr @__kitcuda_register_devcode(ptr)\n"
      "declare void @__kitcuda_register_devcode_end(ptr)\n"
      "declare void @__kitcuda_register_global(ptr, ptr, ptr, ptr, i64, i32, i32)\n"
      "declare void @__kitcuda_register_global_managed(ptr, ptr, ptr, ptr, i64, i32, i32, i32)\n"
      "declare void @__kitcuda_sync_thread_stream(ptr)\n"
      "declare void @__kitcuda_unregister_devcode(ptr)\n"
      "declare void @__kithip_enable_xnack()\n"
      "declare void @__kithip_enable_ylaunch()\n"
      "declare void @__kithip_finalize()\n"
      "declare ptr @__kithip_get_global_symbol(ptr, ptr)\n"
      "declare ptr @__kithip_get_thread_stream()\n"
      "declare void @__kithip_initialize()\n"
      "declare ptr @__kithip_launch_kernel(ptr, ptr, ptr, i64, i64, i64, i32, ptr, ptr)\n"
      "declare ptr @__kithip_mem_alloc_managed(i64)\n"
      "declare void @__kithip_mem_free(ptr)\n"
      "declare ptr @__kithip_mem_gpu_prefetch(ptr, i64, ptr)\n"
      "declare ptr @__kithip_mem_host_prefetch(ptr, i64, ptr)\n"
      "declare void @__kithip_memcpy_sym_to_device(ptr, ptr, i64)\n"
      "declare void @__kithip_memcpy_sym_to_host(ptr, ptr, i64)\n"
      "declare i64 @__kithip_reduce_num_partials(i64)\n"
      "declare ptr @__kithip_register_devcode(ptr)\n"
      "declare void @__kithip_register_devcode_end(ptr)\n"
      "declare void @__kithip_register_global(ptr, ptr, ptr, ptr, i64, i32, i32)\n"
      "declare void @__kithip_register_global_managed(ptr, ptr, ptr, ptr, i64, i32, i32, i32)\n"
      "declare void @__kithip_sync_thread_stream(ptr)\n"
      "declare void @__kithip_unregister_devcode(ptr)\n"
      "declare void @__kitocilk_finalize()\n"
      "declare void @__kitocilk_initialize()\n"
      "declare i64 @__kitocilk_num_workers()\n"
      "declare i64 @__kitocilk_reduce_num_partials(i64)\n"
      "declare i64 @__kitocilk_worker_id()\n"
      "declare void @__kitomp_finalize()\n"
      "declare void @__kitomp_initialize()\n"
      "declare void @__kitomp_launch(ptr, i64, i64, ptr, i64)\n"
      "declare i64 @__kitomp_num_threads()\n"
      "declare i64 @__kitomp_reduce_num_partials(i64)\n"
      "declare i64 @__kitomp_thread_id()\n"
      "declare ptr @__kitpthr_async_launch(ptr, i64, i64, ptr, i64)\n"
      "declare void @__kitpthr_finalize()\n"
      "declare void @__kitpthr_initialize()\n"
      "declare i64 @__kitpthr_num_threads()\n"
      "declare i64 @__kitpthr_reduce_num_partials(i64)\n"
      "declare i64 @__kitpthr_thread_id()\n"
      "declare void @__kitpthr_sync(ptr)\n"
      "declare void @__kitqthr_finalize()\n"
      "declare void @__kitqthr_initialize()\n"
      "declare void @__kitqthr_launch(ptr, i64, i64, ptr, i64)\n"
      "declare i64 @__kitqthr_num_workers()\n"
      "declare i64 @__kitqthr_reduce_num_partials(i64)\n"
      "declare i64 @__kitqthr_worker_id()\n"
      ...
      "declare void @__kitrt_mobile_init_from(ptr, i64, ptr, i32)\n"
      "declare void @__kitrt_mobile_init_i8(ptr, i64, i8)\n"
      "declare void @__kitrt_mobile_init_i16(ptr, i64, i16)\n"
      "declare void @__kitrt_mobile_init_i32(ptr, i64, i32)\n"
      "declare void @__kitrt_mobile_init_i64(ptr, i64, i64)\n"
      "\n");
