...
TEST_F(TargetLibraryInfoTest, ValidProto) {
  parseAssembly(
      ...
      // These are functions from libcuda that are used directly in code
      // generated by Kitsune. If a new runtime function is added, but this list
      // is not updated, the test below will fail.
      "declare ptr @__cudaRegisterFatBinary(ptr)\n"
      "declare void @__cudaRegisterFatBinaryEnd(ptr)\n"
      "declare void @__cudaRegisterManagedVar(ptr, ptr, ptr, ptr, i32, i64, "
      "i32, i32)\n"
      "declare void @__cudaRegisterVar(ptr, ptr, ptr, ptr, i32, i64, i32, "
      "i32)\n"
      "declare void @__cudaUnregisterFatBinary(ptr)\n"

      // These are functions from libamdhip that are used directly in code
      // generated by Kitsune. If a new runtime function is added, but this list
      // is not updated, the test below will fail.
