//=- KitsuneStringExtras.cpp - String and serialization functions -*- C++ -*-=//
//
...
std::string llvm::toString(const TapirTargetID &tt) {
  switch (tt) {
...
raw_ostream &llvm::operator<<(raw_ostream &os, const TapirTargetID &tt) {
  os << toString(tt);
  return os;
}
