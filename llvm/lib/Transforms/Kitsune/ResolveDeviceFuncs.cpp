...
protected:
  ResolveDeviceFuncs(TapirTargetID tt, const TapirTargetOptions &tto)
      : tt(tt), tto(tto) {}
...
public:
  ResolveDeviceFuncsCuda(const TapirTargetOptions &tto)
      : ResolveDeviceFuncs(TapirTargetID::Cuda, tto) {}
};
...
public:
  ResolveDeviceFuncsHip(const TapirTargetOptions &tto)
      : ResolveDeviceFuncs(TapirTargetID::Hip, tto) {}
};
...
bool ResolveDeviceFuncsPass::run(TapirTargetID tt, Module &devM, Module &hostM,
