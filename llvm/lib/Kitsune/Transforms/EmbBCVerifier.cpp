...
bool llvm::verifyEmbBC(TTID tt, Module &hostM, raw_ostream *os) {
  if (std::unique_ptr<Module> embM = getEmbModule(tt, hostM))
...
bool VerifyEmbBCPass::run(TTID tt, Module &km, Module &hostM,
