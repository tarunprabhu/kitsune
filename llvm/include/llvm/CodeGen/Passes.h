...
/// Create a pass to convert any embedded "fat bitcode" files generated by
/// the tapir targets to a fat binary.
LLVM_ABI ModulePass* createCodeGenKitsuneFatBinariesLegacyPass();
