//=- OptimizationLevel.h - Optimization levels provided by LLVM -*- C++ -*---=//
//
...
//===----------------------------------------------------------------------===//
///
/// The content of llvm/Passes/OptimizationLevel.h has been moved here. Kitsune
/// uses the optimization level in many parts of the compiler that upstream
/// LLVM does not. As a result, this had to be moved here so it could be shared
/// without causing circular dependences.
///
//===----------------------------------------------------------------------===//

#ifndef KITSUNE_CORE_OPTIMIZATION_LEVEL_H
#define KITSUNE_CORE_OPTIMIZATION_LEVEL_H
...
#endif // KITSUNE_CORE_OPTIMIZATION_LEVEL_H
