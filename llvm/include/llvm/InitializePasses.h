...
void initializeLowerKitsuneIntrinsicsLegacyPassPass(PassRegistry &);
...
void initializeStripKitsuneAddrSpacesLegacyPassPass(PassRegistry &);
void initializeStructurizeCFGLegacyPassPass(PassRegistry &);
void initializeTailCallElimPass(PassRegistry &);
void initializeTailDuplicateLegacyPass(PassRegistry &);
void initializeTapirCleanupPass(PassRegistry &);
void initializeTapirTargetAnalysisWrapperPassPass(PassRegistry &);
