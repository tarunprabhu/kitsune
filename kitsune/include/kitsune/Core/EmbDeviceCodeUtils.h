...
/// Is the architecture a known AMDGPU architecture.
bool isAMDGPUArch(StringRef arch);

/// Is the architecture a known NVIDIA architecture (sm_*).
bool isNVArch(StringRef arch);

/// Is the architecture a known NVIDIA virtual architecture (compute_*).
bool isNVVirtArch(StringRef arch);
...
/// Get the name of the section in which the device code with the given
/// architecture should be embedded.
Expected<StringRef> getSectionForArch(StringRef arch);
