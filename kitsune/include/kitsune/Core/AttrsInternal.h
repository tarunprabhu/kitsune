...
#define DECL_ATTR_COMMON(IRELEM, NAME, IRNAME, CUSTOMVERIFY, TYPE)             \
  ...
  bool verify##NAME##Attr(const IRELEM &ir, raw_ostream *os = nullptr);
...
#define DECL_ATTR_LOOP(IRELEM, NAME, IRNAME, CUSTOMVERIFY)                     \
  ...
  bool verify##NAME##Attr(const IRELEM &ir, const MDNode &md, raw_ostream *os);
...
#define DECL_ATTR_0(IRELEM, NAME, IRNAME, CUSTOMVERIFY)                        \
  ...
  bool verify##NAME##Attr(const IRELEM &ir, const bool &t, raw_ostream *os);
...
#define DECL_ATTR_1(IRELEM, NAME, IRNAME, CUSTOMVERIFY, TYPE)                  \
  ...
  bool verify##NAME##Attr(const IRELEM &ir, const TYPE &val, raw_ostream *os);
...
#define DECL_ATTR_2(IRELEM, NAME, IRNAME, CUSTOMVERIFY, ETY0, ENAME0, EN0,     \
  ...
  bool verify##NAME##Attr(const IRELEM &ir, const ETY0 &v0, const ETY1 &v1,    \
                          raw_ostream *os);
...
#define DECL_ATTR_4(IRELEM, NAME, IRNAME, CUSTOMVERIFY, ETY0, ENAME0, EN0,     \
  ...
  bool verify##NAME##Attr(const IRELEM &ir, const ETY0 &v0, const ETY1 &v1,    \
                          const ETY2 &v2, const ETY3 &v3, raw_ostream *os);
...
#define DECL_ATTR_7(IRELEM, NAME, IRNAME, CUSTOMVERIFY, ETY0, ENAME0, EN0,     \
  ...
  bool verify##NAME##Attr(const IRELEM &ir, const ETY0 &v0, const ETY1 &v1,    \
                          const ETY2 &v2, const ETY3 &v3, const ETY4 &v4,      \
                          const ETY5 &v5, const ETY6 &v6, raw_ostream *os);
