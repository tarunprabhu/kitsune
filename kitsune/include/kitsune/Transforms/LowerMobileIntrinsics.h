...
#ifndef KITSUNE_TRANSFORMS_LOWER_MOBILE_INTRINSICS_H
#define KITSUNE_TRANSFORMS_LOWER_MOBILE_INTRINSICS_H
...
#endif // KITSUNE_TRANSFORMS_LOWER_MOBILE_INTRINSICS_H
