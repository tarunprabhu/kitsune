...
project = "Kitsune"
copyright = "2018-%d, Triad National Security, LLC" % date.today().year
...
html_title = "The Kitsune Compiler"
...
man_page_authors = "The Kitsune Team"
man_pages = [
    ("kitcc", "kitcc", "Kitsune C compiler", [man_page_authors], 1),
    ("kit++", "kit++", "Kitsune C++ compiler", [man_page_authors], 1),
    ("kitfc", "kitfc", "Kitsune Fortran compiler", [man_page_authors], 1),
]
