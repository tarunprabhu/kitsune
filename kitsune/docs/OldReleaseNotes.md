---
# This file is linked off the release notes page. However, this does not appear
# in the main table of contents for the documentation. To stop sphinx from
# complaining about this, declare the page to be an orphan
orphan: true
---
...
* Squashed a nasty bug related to avoiding race conditions and type-based alias analysis
  (TBAA). Added some code to support early TBAA verification to make similar errors appear earlier in the compilation stages (easier bug tracing).
