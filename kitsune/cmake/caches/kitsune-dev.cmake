...
if (DEFINED ENV{OPENCILK_BASE_DIR})
  set(KITSUNE_ENABLE_OPENCILK ON CACHE BOOL "")
  set(OpenCilk_INCLUDE_DIR $ENV{OPENCILK_BASE_DIR}/include CACHE STRING "")
  set(OpenCilk_LIBRARY_DIR $ENV{OPENCILK_BASE_DIR}/lib CACHE STRING "")
