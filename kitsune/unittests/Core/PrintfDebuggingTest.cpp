//=- PrintfDebuggingTest.cpp - Unit tests for "printf-debugging" utilities --=//
//
...
TEST(KitPrintfDebugging, insertPrintfStdoutBuilder) {
...
TEST(KitPrintfDebugging, insertPrintfStderrBuilder) {
  TEST_INSERT_PRINTF_HEADER
...
TEST(KitPrintfDebugging, insertPrintfStdoutInsertPt) {
  TEST_INSERT_PRINTF_HEADER
...
TEST(KitPrintfDebugging, insertPrintfStderrInsertPt) {
  TEST_INSERT_PRINTF_HEADER
