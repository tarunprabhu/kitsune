...
static void addMetadata(Function &f, StringRef name, ArrayRef<Metadata *> ops) {
  ...
  f.addMetadata(name, *MDNode::get(ctx, ops));
}
...
#define FUNC_ATTR_0(NAME, IRNAME)                                              \
  addMetadata(*f, IRNAME, MDString::get(ctx, ""));                             \
                                                                               \
  EXPECT_FALSE(verifyAttr(*f, FuncAttrKind::NAME));                            \
  EXPECT_FALSE(verify##NAME##Attr(*f));                                        \
                                                                               \
  remove##NAME##Attr(*f);

#define FUNC_ATTR(NAME, IRNAME, TYPE)                                          \
  addMetadata(*f, IRNAME, {});                                                 \
                                                                               \
  EXPECT_FALSE(verifyAttr(*f, FuncAttrKind::NAME));                            \
  EXPECT_FALSE(verify##NAME##Attr(*f));                                        \
                                                                               \
...
#define FUNC_ATTR_0(NAME, IRNAME)                                              \
  EXPECT_TRUE(verify##NAME##Attr(*f));                                         \
