...
#define DECL_ATTR_IMPL_LOOP(IRELEM, NAME, IRNAME, CUSTOMVERIFY)                \
  void verify##NAME##Attr(KitVerifier &v, const IRELEM &ir, const MDNode &md);
...
#define DECL_ATTR_IMPL_1(IRELEM, NAME, IRNAME, CUSTOMVERIFY, TYPE)             \
  void verify##NAME##Attr(KitVerifier &v, const IRELEM &ir, const TYPE &val);

#define DECL_ATTR_IMPL_2(IRELEM, NAME, IRNAME, CUSTOMVERIFY, ETY0, ENAME0,     \
                         EN0, ETY1, ENAME1, EN1)                               \
  void verify##NAME##Attr(KitVerifier &v, const IRELEM &ir, const ETY0 &v0,    \
                          const ETY1 &v1);
