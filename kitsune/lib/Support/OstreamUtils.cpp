//===- OstreamUtils.cpp - Utilities to stream types -----------------------===//
//
...
raw_ostream &llvm::operator<<(raw_ostream &os, const GlobalISelAbortMode &m) {
  switch (m) {
  case GlobalISelAbortMode::Disable: return os << "disable";
  case GlobalISelAbortMode::Enable: return os << "enable";
  case GlobalISelAbortMode::DisableWithDiag: return os << "disable-with-diag";
  }
...
raw_ostream &llvm::operator<<(raw_ostream &os,
  ...
  case SwiftAsyncFramePointerMode::Always: return os << "always";
  case SwiftAsyncFramePointerMode::Never: return os << "never";
  }
...
raw_ostream &llvm::operator<<(raw_ostream &os,
  ...
  switch (dd) {
  case MCTargetOptions::DisableDwarfDirectory: return os << "disable";
  case MCTargetOptions::EnableDwarfDirectory: return os << "enable";
  case MCTargetOptions::DefaultDwarfDirectory: return os << "default";
  }
...
raw_ostream &llvm::operator<<(raw_ostream &os, const EmitDwarfUnwindType &du) {
  switch (du) {
  case EmitDwarfUnwindType::Always: return os << "always";
  case EmitDwarfUnwindType::NoCompactUnwind: return os << "no-compact-unwind";
  case EmitDwarfUnwindType::Default: return os << "default";
  }
