; The destination of a reduction cannot be used as the unit operand of a
; reduction.
;
...
for.i.body:
  ...
  call void(i32, i32, ptr, i32, ptr, ptr, ptr, ...) @llvm.kit.reduce.0(i32 1, i32 5, ptr %res, i32 8, ptr %iptr, ptr %res, ptr @custom)
