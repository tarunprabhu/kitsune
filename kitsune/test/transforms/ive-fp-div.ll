; Check that a secondary induction variable that is a floating point div
...
; CHECK-EMPTY:
; CHECK-NEXT: [[BODY]]:
; CHECK-NEXT: %[[STRIDE:.+]] = call float @llvm.powi.f32.i64(float 5.000000e-01, i64 %[[PRIMIV]])
; CHECK-NEXT: %[[REPL:.+]] = fdiv float 9.900000e+01, %[[STRIDE]]
