; Calls to the intrinsic that operate on different numbers of elements are never
; grouped,
;
...
; CHECK-NEXT: %[[CMP1:.+]] = icmp eq i64 %[[INC1]], %[[N1]]
...
; CHECK-NEXT: %[[CMP2:.+]] = icmp eq i64 %[[INC2]], %[[N2]]
...
; CHECK-NEXT: %[[CMP3:.+]] = icmp eq i64 %[[INC3]], %[[N1]]
...
define void @f1(ptr addrspace(67) %buf1, ptr addrspace(67) %buf2, ptr addrspace(67) %buf3, i64 %n1, i64 %n2) {
entry:
  %r1 = alloca i32
  %r2 = alloca i32
  %r3 = alloca i32
  call void(i32, ptr, i32, ptr addrspace(67) , i64, i32, ptr, ...) @llvm.kit.reduce.1(i32 1, ptr %r1, i32 4, ptr addrspace(67) %buf1, i64 %n1, i32 1, ptr @mul)
  call void(i32, ptr, i32, ptr addrspace(67) , i64, i32, ptr, ...) @llvm.kit.reduce.1(i32 1, ptr %r2, i32 4, ptr addrspace(67) %buf2, i64 %n2, i32 1, ptr @mul)
  call void(i32, ptr, i32, ptr addrspace(67) , i64, i32, ptr, ...) @llvm.kit.reduce.1(i32 1, ptr %r3, i32 4, ptr addrspace(67) %buf3, i64 %n1, i32 1, ptr @mul)
  ret void
}
