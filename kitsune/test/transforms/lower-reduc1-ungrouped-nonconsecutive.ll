; Calls to the intrinsic that have intervening non-debug instructions are not
; merged.
;
...
; CHECK-EMPTY:
; CHECK-NEXT: [[END]]:
; CHECK-NEXT: ret i32 %[[N32]]

declare void @mul(ptr %res, i32 %v)

define i32 @f1(ptr addrspace(67) %buf1, ptr addrspace(67) %buf2, ptr addrspace(67) %buf3, i64 %n) {
entry:
  %r1 = alloca i32
  %r2 = alloca i32
  %r3 = alloca i32
