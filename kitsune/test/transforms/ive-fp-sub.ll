; Check that a secondary induction variable that is a floating point sub
...
; CHECK-EMPTY:
; CHECK-NEXT: [[BODY]]:
; CHECK-NEXT: %[[CST:.+]] = sitofp i64 %[[PRIMIV]] to double
; CHECK-NEXT: %[[STRIDE:.+]] = fmul double %[[CST]], 5.000000e-01
