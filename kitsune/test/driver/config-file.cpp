// The lit configuration file sets the CLANG_NO_DEFAULT_CONFIG environment
// variable that disables loading of default configuration files. When testing
// that default configuration files are loaded correctly, we must ensure that
// the CLANG_NO_DEFAULT_CONFIG environment variable is unset.
//
// -----------------------------------------------------------------------------
