...
! explicitly in the past, but are not any longer. Calls to functions provided by
! these libraries should not be added directly by any lowering passes. Instead,
! a wrapper should be provided in libkitrt, and that should be called.
!
! CHECK-NOT: "-ldl"
! CHECK-NOT: "-lm"
! CHECK-NOT: "-lpthread"
...
!
! CHECK-NEXT: "-lkitrt"
! TODO: Check that any requied Fortran libraries are also present in the link
! line.
