...
!
! RUN: %kitfc -### -ftapir=serial --config-kitsune-dir=%S/ %s 2>&1 \
...
!
! RUN: %kitfc -### -ftapir=serial --config-kitsune-dir=%S/input %s 2>&1 \
...
! CHECK-CUSTOM: Configuration file: {{.*}}/input/serial.cfg
! CHECK-CUSTOM: "-fc1"
