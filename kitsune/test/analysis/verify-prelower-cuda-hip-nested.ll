...
; diagnostic is emitted when at least one subloop has the hip tapir target.
;
...
; RUN:     | FileCheck %s
;
; CHECK: tapir targets 'hip' and 'cuda' are incompatible in GPU loop nest
