...
// CHECK-SAME: (i32 0, i32 17, ptr %[[R]], i32 4, float %[[V]],
// CHECK-SAME: float 0x3810000000000000,
// CHECK-SAME: ptr @__kitsune_reduce.maximum.f32)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.maximum.f32
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: float {{.*}}%[[V:[^)]+]]
...
void reduce_f32() {
  float r;
  __kitsune_reduce(&r, KIT_MAXIMUM, r);
}
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 17, ptr %[[R]], i32 8, double %[[V]],
// CHECK-SAME: double 0x10000000000000,
// CHECK-SAME: ptr @__kitsune_reduce.maximum.f64)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.maximum.f64
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: double {{.*}}%[[V:[^)]+]]
...
// regenerated.
//
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.maximum.f32
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.maximum.f64
void reduce_max_2() {
  float f32;
  double f64;
