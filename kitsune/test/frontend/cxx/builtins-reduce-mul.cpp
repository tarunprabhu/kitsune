...
// CHECK-SAME: (i32 0, i32 7, ptr %[[R]], i32 1, i8 %[[V]], i8 1,
// CHECK-SAME: ptr @__kitsune_reduce.mul.i8)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.mul.i8
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i8 {{.*}}%[[V:[^)]+]]
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 7, ptr %[[R]], i32 2, i16 %[[V]], i16 1,
// CHECK-SAME: ptr @__kitsune_reduce.mul.i16)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.mul.i16
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i16 {{.*}}%[[V:[^)]+]]
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 7, ptr %[[R]], i32 4, i32 %[[V]], i32 1,
// CHECK-SAME: ptr @__kitsune_reduce.mul.i32)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.mul.i32
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i32 {{.*}}%[[V:[^)]+]]
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 7, ptr %[[R]], i32 8, i64 %[[V]], i64 1,
// CHECK-SAME: ptr @__kitsune_reduce.mul.i64)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.mul.i64
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i64 {{.*}}%[[V:[^)]+]]
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 8, ptr %[[R]], i32 4, float %[[V]],
// CHECK-SAME: float 1.000000e+00,
// CHECK-SAME: ptr @__kitsune_reduce.mul.f32)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.mul.f32
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: float {{.*}}%[[V:[^)]+]]
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 8, ptr %[[R]], i32 8, double %[[V]],
// CHECK-SAME: double 1.000000e+00,
// CHECK-SAME: ptr @__kitsune_reduce.mul.f64)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.mul.f64
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: double {{.*}}%[[V:[^)]+]]
...
// regenerated.
//
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.mul.i64
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.mul.f32
extern "C" void reduce_mul_2() {
  int64_t i64;
  uint64_t u64;
  float f32;
