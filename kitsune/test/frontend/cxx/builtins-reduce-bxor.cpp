...
// CHECK-SAME: ptr @__kitsune_reduce.bxor.i8)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.bxor.i8
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i8 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.bxor.i8)
//
// CHECK-NOT: @__kitsune_reduce.bxor.u8
...
// CHECK-SAME: ptr @__kitsune_reduce.bxor.i16)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.bxor.i16
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i16 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.bxor.i16)
//
// CHECK-NOT: @__kitsune_reduce.bxor.u16
...
// CHECK-SAME: ptr @__kitsune_reduce.bxor.i32)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.bxor.i32
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i32 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.bxor.i32)
//
// CHECK-NOT: @__kitsune_reduce.bxor.u32
...
// CHECK-SAME: ptr @__kitsune_reduce.bxor.i64)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.bxor.i64
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i64 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.bxor.i64)
//
// CHECK-NOT: @__kitsune_reduce.bxor.u64
...
// regenerated.
//
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.bxor.i32
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.bxor.i64
extern "C" void reduce_or_2() {
  int32_t i32;
  int64_t i64;
  uint64_t u64;
