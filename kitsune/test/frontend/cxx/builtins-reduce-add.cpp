...
// CHECK-SAME: (i32 0, i32 5, ptr %[[R]], i32 1, i8 %[[V]], i8 0,
// CHECK-SAME: ptr @__kitsune_reduce.add.i8)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.add.i8
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i8 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.add.i8)
//
// CHECK-NOT: @__kitsune_reduce.add.u8
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 5, ptr %[[R]], i32 2, i16 %[[V]], i16 0,
// CHECK-SAME: ptr @__kitsune_reduce.add.i16)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.add.i16
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i16 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.add.i16)
//
// CHECK-NOT: @__kitsune_reduce.add.u16
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 5, ptr %[[R]], i32 4, i32 %[[V]], i32 0,
// CHECK-SAME: ptr @__kitsune_reduce.add.i32)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.add.i32
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i32 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.add.i32)
//
// CHECK-NOT: @__kitsune_reduce.add.u32
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 5, ptr %[[R]], i32 8, i64 %[[V]], i64 0,
// CHECK-SAME: ptr @__kitsune_reduce.add.i64)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.add.i64
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i64 {{.*}}%[[V:[^)]+]]
...
// CHECK-NEXT: ret void
//
// CHECK-NOT: @__kitsune_reduce.add.u64
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 6, ptr %[[R]], i32 4, float %[[V]],
// CHECK-SAME: float 0.000000e+00,
// CHECK-SAME: ptr @__kitsune_reduce.add.f32)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.add.f32
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: float {{.*}}%[[V:[^)]+]]
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 6, ptr %[[R]], i32 8, double %[[V]],
// CHECK-SAME: double 0.000000e+00,
// CHECK-SAME: ptr @__kitsune_reduce.add.f64)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.add.f64
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: double {{.*}}%[[V:[^)]+]]
...
// regenerated.
//
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.add.i64
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.add.f32
void reduce_add_2() {
  int64_t i64;
  uint64_t u64;
  float f32;
