...
// CHECK-SAME: (i32 0, i32 1, ptr %[[R]], i32 1, i8 %[[V]], i8 -1,
// CHECK-SAME: ptr @__kitsune_reduce.and.u8)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.and.u8
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i8 {{.*}}%[[V:[^)]+]]
// CHECK-NEXT: %[[CURR:.+]] = load i8, ptr %[[PTR]]
// CHECK-NEXT: %[[UPD:.+]] = and i8 %[[CURR]], %[[V]]
// CHECK-NEXT: store i8 %[[UPD]], ptr %[[PTR]]
// CHECK-NEXT: ret void
extern "C" void reduce_i8() {
  int8_t r;
  __kitsune_reduce(&r, KIT_AND, r);
}
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 1, ptr %[[R]], i32 2, i16 %[[V]], i16 -1,
// CHECK-SAME: ptr @__kitsune_reduce.and.u16)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.and.u16
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i16 {{.*}}%[[V:[^)]+]]
// CHECK-NEXT: %[[CURR:.+]] = load i16, ptr %[[PTR]]
// CHECK-NEXT: %[[UPD:.+]] = and i16 %[[CURR]], %[[V]]
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 1, ptr %[[R]], i32 4, i32 %[[V]], i32 -1,
// CHECK-SAME: ptr @__kitsune_reduce.and.u32)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.and.u32
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i32 {{.*}}%[[V:[^)]+]]
// CHECK-NEXT: %[[CURR:.+]] = load i32, ptr %[[PTR]]
// CHECK-NEXT: %[[UPD:.+]] = and i32 %[[CURR]], %[[V]]
...
// CHECK-NEXT: call {{.+}} @llvm.kit.reduce.0{{[^(]+}}
// CHECK-SAME: (i32 0, i32 1, ptr %[[R]], i32 8, i64 %[[V]], i64 -1,
// CHECK-SAME: ptr @__kitsune_reduce.and.u64)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.and.u64
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i64 {{.*}}%[[V:[^)]+]]
// CHECK-NEXT: %[[CURR:.+]] = load i64, ptr %[[PTR]]
// CHECK-NEXT: %[[UPD:.+]] = and i64 %[[CURR]], %[[V]]
...
// regenerated.
//
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.and.u32
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.and.u64
void reduce_and_2() {
  int32_t i32;
  int64_t i64;
  uint64_t u64;
