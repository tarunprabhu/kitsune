...
// CHECK-SAME: ptr @__kitsune_reduce.band.i8)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.band.i8
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i8 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.band.i8)
//
// CHECK-NOT: @__kitsune_reduce.band.u8
...
// CHECK-SAME: ptr @__kitsune_reduce.band.i16)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.band.i16
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i16 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.band.i16)
//
// CHECK-NOT: @__kitsune_reduce.band.u16
...
// CHECK-SAME: ptr @__kitsune_reduce.band.i32)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.band.i32
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i32 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.band.i32)
//
// CHECK-NOT: @__kitsune_reduce.band.u32
...
// CHECK-SAME: ptr @__kitsune_reduce.band.i64)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.band.i64
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i64 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.band.i64)
//
// CHECK-NOT: @__kitsune_reduce.band.u64
...
// regenerated.
//
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.band.i32
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.band.i64
extern "C" void reduce_and_2() {
  int32_t i32;
  int64_t i64;
  uint64_t u64;
