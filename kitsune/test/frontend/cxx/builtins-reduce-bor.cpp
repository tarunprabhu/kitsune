...
// CHECK-SAME: ptr @__kitsune_reduce.bor.i8)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.bor.i8
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i8 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.bor.i8)
//
// CHECK-NOT: @__kitsune_reduce.bor.u8
...
// CHECK-SAME: ptr @__kitsune_reduce.bor.i16)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.bor.i16
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i16 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.bor.i16)
//
// CHECK-NOT: @__kitsune_reduce.bor.u16
...
// CHECK-SAME: ptr @__kitsune_reduce.bor.i32)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.bor.i32
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i32 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.bor.i32)
//
// CHECK-NOT: @__kitsune_reduce.bor.u32
...
// CHECK-SAME: ptr @__kitsune_reduce.bor.i64)
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.bor.i64
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i64 {{.*}}%[[V:[^)]+]]
...
// CHECK-SAME: ptr @__kitsune_reduce.bor.i64)
//
// CHECK-NOT: @__kitsune_reduce.bor.u64
...
// regenerated.
//
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.bor.i32
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.bor.i64
