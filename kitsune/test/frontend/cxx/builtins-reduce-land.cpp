...
// CHECK-SAME: (i32 0, ptr %[[B]], i32 1, i1 %[[VB]], i1 true,
// CHECK-SAME: ptr @__kitsune_reduce.land.i1)
//
// CHECK-NEXT: ret void
//
// CHECK-LABEL: define linkonce_odr void @__kitsune_reduce.land.i1
// CHECK-SAME: ptr %[[PTR:[^,]+]]
// CHECK-SAME: i1 {{.*}}%[[V:[^)]+]]
// CHECK-NEXT: %[[CURR:.+]] = load i1, ptr %[[PTR]]
// CHECK-NEXT: %[[UPD:.+]] = and i1 %[[CURR]], %[[V]]
// CHECK-NEXT: store i1 %[[UPD]], ptr %[[PTR]]
// CHECK-NEXT: ret void

extern "C" void reduce_land() {
  bool b;
...
// regenerated.
//
// CHECK-NOT: define linkonce_odr void @__kitsune_reduce.land.i1
extern "C" void reduce_land_2() {
  bool b;
