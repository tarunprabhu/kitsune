...
!
! -----------------------------------------------------------------------------
! RUN: %kitfc -### --tapir=hip --tapir-hip-xnack=on %s 2>&1 \
! RUN:     | FileCheck %s -check-prefixes ALL,ON
!
! RUN: %kitfc -### --tapir=hip --tapir-hip-xnack=off %s 2>&1 \
! RUN:     | FileCheck %s -check-prefixes ALL,OFF
!
! RUN: %kitfc -### --tapir=hip --tapir-hip-xnack=any %s 2>&1 \
...
! -----------------------------------------------------------------------------
!
! RUN: not %kitfc -### --tapir=hip --tapir-hip-xnack= %s 2>&1  \
...
! -----------------------------------------------------------------------------
!
! RUN: not %kitfc -### --tapir=hip --tapir-hip-xnack=ignore %s 2>&1 \
