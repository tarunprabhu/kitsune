...
; CHECK-EMPTY:
; CHECK-NEXT: [[PH_O]]:
; CHECK-NEXT: %[[NREDS:.+]] = call i64 @llvm.kit.cpu.num.threads(i32 1024)
...
; CHECK-EMPTY:
; CHECK-NEXT: [[PH_I]]:
; CHECK-NEXT: %[[LOCAL:.+]] = tail call noalias ptr @llvm.kit.cpu.malloc(i32 1024, i64 8)
...
; CHECK-NEXT: call void @llvm.kit.cpu.free(i32 1024, ptr %[[LOCAL]])
...
for.i.body:
  call void(i32, i32, ptr, i32, i64, i64, ptr, ...) @llvm.kit.reduce.0(i32 1024, i32 5, ptr %result, i32 8, i64 %i, i64 0, ptr @sum)
