...
// and we are more interested in testing exactly what the qthreads tapir target
// generates.
//
// RUN: %kitcc --tapir=qthreads -O1 %s %sysroot -S -emit-llvm -o /dev/null \
