...
for.j.latch:
  ...
  br i1 %exitcond.j.not, label %for.j.exit, label %for.j.header, !llvm.loop !0
...
for.j.body:
  br i1 %cmp.p.not, label %for.k.exit, label %for.k.body

for.k.body:
  %k = phi i64 [ 0, %for.j.body ], [ %inc.k, %for.k.body ]
  %inc.k = add nuw i64 %k, 1
  %exitcond.k.not = icmp eq i64 %inc.k, %p
  br i1 %exitcond.k.not, label %for.k.exit, label %for.k.body, !llvm.loop !3
