...
; all some loops have a tapir.loop.name attribute, while others don't.
;
; RUN: opt --tapir=cuda -passes='loop-spawning' %s \
; RUN:     | %kit-mbc -S \
; RUN:     | FileCheck %s
;
; CHECK-DAG: define {{.+}} @__kitcuda_loop_scale_{{[0-9]}}(
; CHECK-DAG: define {{.+}} @__kitcuda_loop__stdin__6_3_{{[0-9]}}(
; CHECK-DAG: define {{.+}} @__kitcuda_loop_xlate_{{[0-9]}}(
...
!0 = distinct !{!0, !1, !2, !3, !6, !7}
!1 = !{!"tapir.loop.spawn.strategy", i32 3}
!2 = !{!"tapir.loop.target", i32 2}
!3 = !{!"tapir.loop.lowering.enabled"}
!4 = distinct !{!4, !1, !2, !3, !6, !7, !8}
!5 = distinct !{!5, !1, !2, !3, !6, !7}
