...
for.l.latch:
  ...
  br i1 %exitcond.l.not, label %for.l.exit, label %for.l.header, !llvm.loop !0
...
for.k.latch:
  ...
  br i1 %exitcond.k.not, label %for.k.exit, label %for.k.header, !llvm.loop !2
...
for.j.latch:
  ...
  br i1 %exitcond.j.not, label %for.j.exit, label %for.j.header, !llvm.loop !3
...
for.i.latch:
  ...
  br i1 %exitcond.i.not, label %for.i.exit, label %for.i.header, !llvm.loop !4
...
; CHECK-DAG: ![[PPPP_I]] = distinct !{![[PPPP_I]], ![[TARGET]], ![[D4]], ![[L1]]}
;
;-------------------------------------------------------------------------------
