...
;
; CHECK: define void @f() {
; CHECK-NEXT: call i32 @__kit_cuda_warp_lane(i32 1)
; CHECK-NEXT: call i32 @__kit_cuda_warp_lane(i32 2)
; CHECK-NEXT: call i32 @__kit_cuda_warp_lane(i32 3)
; CHECK-NEXT: ret void
;
; CHECK: define linkonce_odr i32 @__kit_cuda_warp_lane
; CHECK-SAME: i32 %[[DIMS:[^)]+]]
...
; CHECK-NEXT: %[[WARPSIZE:.+]] = call i32 @llvm.kit.gpu.warp.size(i32 2)
