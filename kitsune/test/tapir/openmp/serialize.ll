; Check that the serialize pass does not serialize anything when the openmp
...
; that can be exploited by openmp. If that happens, we may well end up
...
;     }
; }
define void @pep(i64 %m, i64 %n) !kit.func !5 {
entry:
