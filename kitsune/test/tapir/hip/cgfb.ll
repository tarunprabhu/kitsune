; Check that a global containing embedded object code is generated correctly.
; The global containing embedded bitcode should be removed after the object code
; is generated. The singleton global containing the fat binary should remain
; unchanged.
;
...
; CHECK-DAG: attributes #[[OBJATTR]] = { kit_tt(4) }
; CHECK-NOT: kit_bc
