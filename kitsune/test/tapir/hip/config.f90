...
!
! RUN: %kitfc -### -ftapir=hip --config-kitsune-dir=%S -O1 %s 2>&1 | \
...
!
! RUN: %kitfc -### -ftapir=hip --config-kitsune-dir=%S/input -O1 %s 2>&1 \
...
! CHECK-CUSTOM: Configuration file: {{.*}}/input/hip.cfg
! CHECK-CUSTOM: "-fc1"
