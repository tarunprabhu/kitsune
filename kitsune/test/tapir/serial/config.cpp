...
//
// RUN: %kitxx -### --tapir=serial -O1 --config-system-dir=%S/ %s 2>&1 \
// RUN:     | FileCheck %s -check-prefix=CUSTOM-NOEXIST
//
// COM: %kitxx -### --tapir=serial -O1 --config-user-dir=%S/ %s 2>&1 \
// COM:     | FileCheck %s -check-prefix=CUSTOM-NOEXIST
//
// CUSTOM-NOEXIST-NOT: Configuration file: {{.*}}/serial.cfg
//
// -----------------------------------------------------------------------------
...
//
// RUN: %kitxx -### --tapir=serial -O1 --config-system-dir=%S/input %s 2>&1 \
// RUN:     | FileCheck %s -check-prefix=CUSTOM
//
// RUN: %kitxx -### --tapir=serial -O1 --config-user-dir=%S/input %s 2>&1 \
// RUN:     | FileCheck %s -check-prefix=CUSTOM
//
// CUSTOM: Configuration file: {{.*}}/input/serial.cfg
// CUSTOM: "-cc1"
// CUSTOM-SAME: "-D" "serial_preprocessor_flag"
// CUSTOM-SAME: "-Wserial_compiler_flag"
// CUSTOM-NEXT: "-serial_linker_flag"
//
// -----------------------------------------------------------------------------
...
// BOTH: Configuration file: {{.*}}/input/cfgs/serial.cfg
// BOTH: "-cc1"
// BOTH-SAME: "-D" "serial_driver_preprocessor_flag"
// BOTH-SAME: "-D" "serial_custom_preprocessor_flag"
// BOTH-SAME: "-Wserial_driver_compiler_flag"
// BOTH-SAME: "-Wserial_custom_compiler_flag"
// BOTH-NEXT: "-serial_driver_linker_flag"
// BOTH-SAME: "-serial_custom_linker_flag"
