...
define void @f(ptr %buf, i64 %n) {
  ...
  ; CHECK-NEXT: %[[GSYM:.+]] = call ptr @__kitcuda_get_global_symbol
  ...
  ; CHECK-NEXT: call void @__kitcuda_memcpy_htod
  ; CHECK-SAME: (i64 %[[GSYMI]], ptr @gbuf, i64 28)
  call void @llvm.kit.gpu.memcpy.htod(i32 2, ptr %2, ptr @gbuf, i64 28)

  ; CHECK-NEXT: call ptr @__kitcuda_mem_gpu_prefetch
  ...
  ; CHECK-NEXT: call ptr @__kitcuda_launch_kernel
  ; CHECK-SAME: (ptr null,
  ; CHECK-SAME: ptr @.name,
  ; CHECK-SAME: i64 128,
  ; CHECK-SAME: i64 0,
  ...
  ; CHECK-NEXT: %[[GSYMI:.+]] = ptrtoint ptr %[[GSYM]] to i64
  ; CHECK-NEXT: call void @__kitcuda_memcpy_dtoh
  ; CHECK-SAME: (ptr @gbuf, i64 %[[GSYMI]], i64 28)
  call void @llvm.kit.gpu.memcpy.dtoh(i32 2, ptr @gbuf, ptr %2, i64 28)

  ; CHECK-NEXT: call ptr @__kitcuda_mem_host_prefetch
  ; CHECK-SAME: (ptr %[[BUF]], i64 -1, ptr %[[STREAM]])
  ...
  ; CHECK-NEXT: call void @__kitcuda_memset_bool
  ; CHECK-SAME: (ptr %[[MALLOCED]], i64 63, i8 1)
  call void(i32, ptr, i64, i1, ...) @llvm.kit.gpu.memset.i1(i32 2, ptr %malloced, i64 63, i1 true)

  ; CHECK-NEXT: call void @__kitcuda_memset_i8
  ; CHECK-SAME: (ptr %[[MALLOCED]], i64 63, i8 1)
  call void(i32, ptr, i64, i8, ...) @llvm.kit.gpu.memset.i8(i32 2, ptr %malloced, i64 63, i8 1)

  ; CHECK-NEXT: call void @__kitcuda_memset_i16
  ; CHECK-SAME: (ptr %[[MALLOCED]], i64 31, i16 11)
  call void(i32, ptr, i64, i16, ...) @llvm.kit.gpu.memset.i16(i32 2, ptr %malloced, i64 31, i16 11)

  ; CHECK-NEXT: call void @__kitcuda_memset_i32
  ; CHECK-SAME: (ptr %[[MALLOCED]], i64 15, i32 111)
  call void(i32, ptr, i64, i32, ...) @llvm.kit.gpu.memset.i32(i32 2, ptr %malloced, i64 15, i32 111)

  ; CHECK-NEXT: call void @__kitcuda_memset_i64
  ; CHECK-SAME: (ptr %[[MALLOCED]], i64 7, i64 1111)
  call void(i32, ptr, i64, i64, ...) @llvm.kit.gpu.memset.i64(i32 2, ptr %malloced, i64 7, i64 1111)

  ; CHECK-NEXT: call void @__kitcuda_memset_float
  ; CHECK-SAME: (ptr %[[MALLOCED]], i64 15, float 1.000000e+00)
  call void(i32, ptr, i64, float, ...) @llvm.kit.gpu.memset.float(i32 2, ptr %malloced, i64 15, float 1.0)

  ; CHECK-NEXT: call void @__kitcuda_memset_double
  ; CHECK-SAME: (ptr %[[MALLOCED]], i64 7, double 2.000000e+00)
  call void(i32, ptr, i64, double, ...) @llvm.kit.gpu.memset.double(i32 2, ptr %malloced, i64 7, double 2.0)

  ; CHECK-NEXT: call void @__kitcuda_memset_from
  ; CHECK-SAME: (ptr %[[MALLOCED]], i64 17, ptr null, i32 48)
  call void(i32, ptr, i64, ptr, ...) @llvm.kit.gpu.memset.ptr(i32 2, ptr %malloced, i64 17, ptr null, i32 48)
  ...
  ; CHECK-NEXT: call void @__kitcuda_register_global
  ...
  ; CHECK-NEXT: call void @__kitcuda_register_global_managed
  ; CHECK-SAME: (ptr %[[HANDLE]],
  ; CHECK-SAME: ptr %[[GUVM]],
  ; CHECK-SAME: ptr @gbuf,
  ; CHECK-SAME: ptr @.gname,
