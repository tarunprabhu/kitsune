...
; CHECK-NEXT: %8 = call ptr @__kitcuda_launch_kernel(ptr null, ptr @.name, ptr nonnull %2, i64 128, i32 24, ptr null, ptr %3)
...
define void @f(ptr %buf, i64 %n) {
  ...
  %5 = call ptr (i32, ptr, ptr, i64, i32, ptr, ptr, ...) @llvm.kit.async.launch.kernel(i32 2, ptr null, ptr @.name, i64 128, i32 24, ptr null, ptr %1, ptr null)
