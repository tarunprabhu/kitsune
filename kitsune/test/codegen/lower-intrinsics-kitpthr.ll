...
; CHECK-NEXT: call i32 @__kitpthr_num_threads() #[[THREADS:[0-9]+]]
...
define void @f(ptr %buf, i64 %n) {
  call void @llvm.kit.runtime.initialize(i32 1024) #0
  ...
  %numThreads = call i32 @llvm.kit.cpu.num.threads(i32 1024) #4
