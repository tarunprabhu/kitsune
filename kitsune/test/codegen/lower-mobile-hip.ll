...
;
; Check basic lowering of Kitsune's mobile intrinsics with the hip tapir target.
; These do not have any custom attributes, calling conventions, debug info, or
; metadata. Those will be checked in other tests.
;
...
; CHECK-SAME: i64 %[[N:[^)]+]]
; CHECK-NEXT: %[[PTR:[0-9]+]] = call noalias ptr @__kithip_mem_alloc_managed(i64 %[[N]])
...
define noalias ptr addrspace(67) @allocate(i64 %n) {
  %1 = call noalias ptr addrspace(67) @llvm.kit.mobile.alloc(i32 4, i64 %n)
...
; CHECK-NEXT: call void @__kithip_mem_free(ptr %[[CST]])
; CHECK-NEXT: ret void
define void @deallocate(ptr addrspace(67) %p) {
  call void @llvm.kit.mobile.free(i32 4, ptr addrspace(67) %p)
  ret void
}
...
define void @fi1(ptr addrspace(67) %buf, i64 %n) {
  call void(i32, ptr addrspace(67), i64, i1, ...) @llvm.kit.mobile.init(i32 4, ptr addrspace(67) %buf, i64 %n, i1 false)
  ret void
}
...
define void @fi8(ptr addrspace(67) %buf, i64 %n) {
  call void(i32, ptr addrspace(67), i64, i8, ...) @llvm.kit.mobile.init(i32 4, ptr addrspace(67) %buf, i64 %n, i8 8)
  ret void
}
...
define void @fi16(ptr addrspace(67) %buf, i64 %n) {
  call void(i32, ptr addrspace(67), i64, i16, ...) @llvm.kit.mobile.init(i32 4, ptr addrspace(67) %buf, i64 %n, i16 16)
  ret void
}
...
define void @fi32(ptr addrspace(67) %buf, i64 %n) {
  call void(i32, ptr addrspace(67), i64, i32, ...) @llvm.kit.mobile.init(i32 4, ptr addrspace(67) %buf, i64 %n, i32 32)
  ret void
}
...
define void @fi64(ptr addrspace(67) %buf, i64 %n) {
  call void(i32, ptr addrspace(67), i64, i64, ...) @llvm.kit.mobile.init(i32 4, ptr addrspace(67) %buf, i64 %n, i64 64)
  ret void
}
...
define void @ff32(ptr addrspace(67) %buf, i64 %n, float %init) {
  call void(i32, ptr addrspace(67), i64, float, ...) @llvm.kit.mobile.init(i32 4, ptr addrspace(67) %buf, i64 %n, float %init)
  ret void
}
...
define void @ff64(ptr addrspace(67) %buf, i64 %n, double %init) {
  call void(i32, ptr addrspace(67), i64, double, ...) @llvm.kit.mobile.init(i32 4, ptr addrspace(67) %buf, i64 %n, double %init)
  ret void
}
...
define void @fptr(ptr addrspace(67) %buf, i64 %n, ptr %init) {
  call void(i32, ptr addrspace(67), i64, ptr, ...) @llvm.kit.mobile.init(i32 4, ptr addrspace(67) %buf, i64 %n, ptr %init, i32 256)
  ret void
}
