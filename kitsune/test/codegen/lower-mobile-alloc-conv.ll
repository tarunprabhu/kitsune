...
; NOLO-NEXT: %[[PTR1:[0-9]+]] = call fastcc noalias ptr addrspace(67) @llvm.kit.mobile.alloc(i64 %[[N]])
; NOLO-NEXT: %[[PTR2:[0-9]+]] = call coldcc noalias ptr addrspace(67) @llvm.kit.mobile.alloc(i64 %[[N]])
; NOLO-NEXT: %[[PTR3:[0-9]+]] = call anyregcc noalias ptr addrspace(67) @llvm.kit.mobile.alloc(i64 %[[N]])
; NOLO-NEXT: ret ptr addrspace(67) %[[PTR2]]
;
; ------------------------------------------------------------------------------
