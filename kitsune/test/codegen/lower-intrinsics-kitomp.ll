...
; CHECK-NEXT: call i32 @__kitomp_num_threads()
...
define void @f(ptr %buf, i64 %n) {
  ...
  %numThreads = call i32 @llvm.kit.cpu.num.threads(i32 512)
  %numPartials = call i64 @llvm.kit.reduce.num.partials(i32 512, i64 %n)
