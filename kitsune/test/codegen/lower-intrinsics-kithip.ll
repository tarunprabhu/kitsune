...
; CHECK-NEXT: call ptr @__kithip_mem_gpu_prefetch(ptr %[[BUF]], ptr %[[STREAM]])
; CHECK-NEXT: call ptr @__kithip_mem_gpu_prefetch(ptr %[[BUF]], ptr %[[STREAM]])
...
; CHECK-NEXT: call ptr @__kithip_mem_host_prefetch(ptr %[[BUF]], ptr %[[STREAM]])
; CHECK-NEXT: call ptr @__kithip_mem_host_prefetch(ptr %[[BUF]], ptr %[[STREAM]])
...
define void @f(ptr %buf, i64 %n) {
  ...
  %5 = call ptr (i32, ptr, ptr, i64, i64, i64, i32, ptr, ptr, ...) @llvm.kit.async.launch.kernel(i32 4, ptr null, ptr @.name, i64 128, i64 0, i64 -1, i32 24, ptr null, ptr %1, ptr null)
