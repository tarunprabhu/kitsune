...
define void @f(i64 %n) {
  %1 = call ptr @llvm.kit.async.cpu.threads.launch(i32 1024, ptr @f, i64 0, i64 %n, i64 1, ptr @gbuf)
  %2 = call ptr @llvm.kit.async.cpu.threads.launch(i32 1024, ptr nonnull @f, i64 0, i64 %n, i64 1, ptr nonnull @gbuf) #0
  call void @llvm.kit.cpu.threads.sync(i32 1024, ptr nonnull %2) #1
  ret void
}
