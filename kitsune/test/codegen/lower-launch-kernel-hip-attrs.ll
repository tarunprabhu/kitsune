...
; CHECK: call ptr @__kithip_launch_kernel(ptr nonnull @fb, ptr nonnull @1, ptr nonnull %[[ARRAY1]], i64 %n, i32 0, ptr nonnull @0, ptr %p)
; CHECK: call ptr @__kithip_launch_kernel(ptr nonnull @fb, ptr nonnull @1, ptr nonnull %[[ARRAY2]], i64 %n, i32 0, ptr nonnull @0, ptr %p) #[[ATTRS:[0-9]+]]
; CHECK: ret void
;
...
define void @launch(ptr %p, ptr nonnull %q, i64 %n, float %f) {
  call ptr (i32, ptr, ptr, i64, i32, ptr, ptr, ...) @llvm.kit.async.launch.kernel(i32 4, ptr nonnull @fb, ptr nonnull @1, i64 %n, i32 0, ptr nonnull @0, ptr %p, ptr dereferenceable(32) %q, i32 noundef 98, float %f, ptr null)
  call ptr (i32, ptr, ptr, i64, i32, ptr, ptr, ...) @llvm.kit.async.launch.kernel(i32 4, ptr nonnull @fb, ptr nonnull @1, i64 %n, i32 0, ptr nonnull @0, ptr %p, ptr dereferenceable(32) %q, i32 noundef 98, ptr null) #0
  ret void
}
