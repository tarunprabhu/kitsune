; A test consisting of some nested loops. This is mainly checking that the
; ordering produced is somewhat "reasonable". This is *not* a particularly
; complex set of loops.
;
