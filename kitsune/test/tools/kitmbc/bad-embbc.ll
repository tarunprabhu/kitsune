...
; RUN: %kitmbc %s 2>&1 | FileCheck %s --check-prefix ERROR
;
; ------------------------------------------------------------------------------
;
...
;
; RUN: %kitmbc %s --only hip -S | FileCheck %s --check-prefix HIP
;
; ------------------------------------------------------------------------------
;
; ERROR: error:
...
@.kitsune.emb.bc = constant [3 x i8] c"AB\00", !kitsune.bc !0
