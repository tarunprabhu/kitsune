...
//
// CHECK: define {{.+}} @fill
// CHECK: %[[DEVPTR:.+]] = call ptr @__kitcuda_get_global_symbol(ptr @__kitsune_fatbin_cuda, ptr @[[DEVVAR_NAME]])
// CHECK: call void @__kitcuda_memcpy_sym_to_device(ptr @[[HOSTVAR]], ptr %[[DEVPTR]], i64 4)
