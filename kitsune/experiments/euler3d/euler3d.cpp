...
void compute_step_factor(int nelr, const float *__restrict variables,
                         const float *areas, float *__restrict step_factors) {
...
void compute_flux(int nelr, const int *elements_surrounding_elements,
                  const float *normals, const float *variables, float *fluxes,
                  const float *ff_variable,
...
int main(int argc, char **argv) {
  ...
  cout << "Compute time: " << chrono::duration<double>(end - start).count()
       << endl;
