ifeq ($(kitsune_kokkos_enable),"ON")
  ...
  ifeq ($(BUILD_CUDA_EXPERIMENTS),true)
    ...
    KOKKOS_CUDA_LIBS=-L$(KOKKOS_CUDA_PREFIX)/lib \
				-L$(KOKKOS_CUDA_PREFIX)/lib64 -L$(CUDA_PATH)/lib64 \
				-lkokkoscore -lcudart -ldl
    ...
    KOKKOS_CLANG_CUDA_FLAGS?= $(CLANG_CUDA_FLAGS) -fPIC -std=c++17 \
				...
				-I$(KOKKOS_CUDA_PREFIX)/include/kokkos
    KOKKOS_CLANG_CUDA_LIBS=-L$(KOKKOS_CLANG_CUDA_PREFIX)/lib64 -L$(CUDA_PATH)/lib64 \
				-lkokkoscore -lcudart -ldl -lstdc++
  endif
