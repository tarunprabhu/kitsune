...
// CHECK-RELOAD-NEXT: - {{.*}}Inputs{{.}}config{{.}}i386-qqq.cfg
...
// CHECK-RELOAD1: Configuration files:
// CHECK-RELOAD1-NEXT: - {{.*}}Inputs{{.}}config2{{.}}i386.cfg
...
// CHECK-RELOAD2: Configuration files:
// CHECK-RELOAD2-NEXT: - {{.*}}Inputs{{.}}config{{.}}x86_64-qqq2.cfg
...
// CHECK-RELOAD3: Configuration files:
// CHECK-RELOAD3-NEXT: - {{.*}}Inputs{{.}}config{{.}}x86_64.cfg
...
// CHECK-RELOAD4: Configuration files:
// CHECK-RELOAD4-NEXT: - {{.*}}Inputs{{.}}config{{.}}i386-qqq.cfg
...
// CHECK-RELOAD5: Configuration files:
// CHECK-RELOAD5-NEXT: - {{.*}}Inputs{{.}}config{{.}}x86_64-qqq2.cfg
...
// CHECK-RELOAD6: Configuration files:
// CHECK-RELOAD6-NEXT: - {{.*}}Inputs{{.}}config{{.}}x86_64-qqq.cfg
