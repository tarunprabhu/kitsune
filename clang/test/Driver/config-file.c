...
// CHECK-HHH: Configuration files:
// CHECK-HHH-NEXT: - {{.*}}Inputs{{.}}config-1.cfg
// CHECK-HHH: -Werror
// CHECK-HHH: -std=c99
...
// CHECK-V: Configuration files:
// CHECK-V-NEXT: - {{.*}}Inputs{{.}}config-1.cfg
// CHECK-V: -Werror
// CHECK-V: -std=c99
...
// CHECK-HHH2: Configuration files:
// CHECK=HHH2-NEXT: - {{.*}}Inputs{{.}}config-1.cfg
// CHECK-HHH2: -Werror
// CHECK-HHH2: -std=c99
...
// CHECK-V2: Configuration files:
// CHECK-V2-NEXT: - {{.*}}Inputs{{.}}config-1.cfg
// CHECK-V2: -Werror
// CHECK-V2: -std=c99
...
// CHECK-NESTED: Configuration files:
// CHECK-NESTED-NEXT: - {{.*}}Inputs{{.}}config-2.cfg
...
// CHECK-NESTED2: Configuration files:
// CHECK-NESTED2-NEXT: - {{.*}}Inputs{{.}}config-2.cfg
...
// CHECK-NESTEDa: Configuration files:
// CHECK-NESTEDa-NEXT: - {{.*}}Inputs{{.}}config-2a.cfg
...
// CHECK-NESTED2a: Configuration files:
// CHECK-NESTED2a-NEXT: - {{.*}}Inputs{{.}}config-2a.cfg
...
// CHECK-PRECEDENCE: Configuration files:
// CHECK-PRECEDENCE-NEXT: - {{.*}}Inputs{{.}}config2{{.}}config-4.cfg
...
// CHECK-SAME-CONFIG: Configuration files:
// CHECK-SAME_CONFIG-NEXT: - {{.*}}Inputs{{.}}config2{{.}}config-4.cfg
