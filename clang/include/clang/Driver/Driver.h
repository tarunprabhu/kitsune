...
public:
  ...
  bool CCCIsCXX() const {
    return Mode == GXXMode || Mode == KokkosMode || Mode == FleCSIMode ||
           Mode == ForallMode;
  }
  ...
  bool isForallMode() const { return Mode == ForallMode; }
...
public:
  ...
  void setInstalledDir(StringRef Value) { InstalledDir = Value; }
