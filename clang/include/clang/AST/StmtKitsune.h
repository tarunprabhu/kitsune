...
class KitsuneSpawnStmt : public Stmt {
  SourceLocation SpawnLoc;
  StringRef SyncVar;
  Stmt *SpawnedStmt;

public:
  explicit KitsuneSpawnStmt(SourceLocation SL, StringRef sv)
      : KitsuneSpawnStmt(SL, sv, nullptr) {}

  KitsuneSpawnStmt(SourceLocation SL, StringRef SV, Stmt *S)
      : Stmt(KitsuneSpawnStmtClass), SpawnLoc(SL), SyncVar(SV), SpawnedStmt(S) { }

  // \brief Build an empty spawn statement.
  explicit KitsuneSpawnStmt(EmptyShell Empty)
      : Stmt(KitsuneSpawnStmtClass,  Empty) { }
  ...
  static bool classof(const Stmt *T) {
    return T->getStmtClass() == KitsuneSpawnStmtClass;
  }
...
class KitsuneSyncStmt : public Stmt {
  SourceLocation SyncLoc;
  StringRef SyncVar; 

public:
  KitsuneSyncStmt(SourceLocation SL, StringRef SV) : 
    Stmt(KitsuneSyncStmtClass), SyncLoc(SL), SyncVar(SV) {}

  // \brief Build an empty __sync statement.
  explicit KitsuneSyncStmt(EmptyShell Empty) : Stmt(KitsuneSyncStmtClass, Empty) { }
  ...
  static bool classof(const Stmt *T) {
    return T->getStmtClass() == KitsuneSyncStmtClass;
  }
...
class KitsuneForallStmt : public Stmt {
  enum { INIT, CONDVAR, COND, INC, BODY, END_EXPR };
  Stmt* SubExprs[END_EXPR]; // SubExprs[INIT] is an expression or declstmt.
  SourceLocation LParenLoc, RParenLoc;

public:
  KitsuneForallStmt(const ASTContext &C, Stmt *Init, Expr *Cond, VarDecl *condVar,
          Expr *Inc, Stmt *Body, SourceLocation FL, SourceLocation LP,
          SourceLocation RP);

  /// Build an empty for statement.
  explicit KitsuneForallStmt(EmptyShell Empty) : Stmt(KitsuneForallStmtClass, Empty) {}
  ...
  /// \code
  /// forall (int x = random(); int y = mangle(x); ++x) {
  ///   // ...
  /// }
  /// \endcode
  ...
  /// If this KitsuneForallStmt has a condition variable, return the faux
  ...
  static bool classof(const Stmt *T) {
    return T->getStmtClass() == KitsuneForallStmtClass;
  }
...
/// KitsuneForallRangeStmt - This represents C++0x [stmt.ranged]'s ranged for
...
class KitsuneForallRangeStmt : public Stmt {
...
public:
  KitsuneForallRangeStmt(Stmt *InitStmt, DeclStmt *Range, DeclStmt *Begin,
                     DeclStmt *End, DeclStmt *Index, DeclStmt *IndexEnd,
                     Expr *Cond, Expr *Inc, DeclStmt *LoopVar, Stmt *Body,
                     SourceLocation FL, SourceLocation CAL, SourceLocation CL,
                     SourceLocation RPL);
  KitsuneForallRangeStmt(EmptyShell Empty) : Stmt(KitsuneForallRangeStmtClass, Empty) {}
  ...
  static bool classof(const Stmt *T) {
    return T->getStmtClass() == KitsuneForallRangeStmtClass;
  }
