...
/// ParseKitsuneSyncStatement
///       sync-statement:
///         'sync' identifier ';'
StmtResult Parser::ParseKitsuneSyncStatement() {
  ...
  Token IdentTok = Tok;
  ConsumeToken();
  return Actions.ActOnKitsuneSyncStmt(SyncLoc,
                               IdentTok.getIdentifierInfo()->getName());
}

/// ParseKitsuneSpawnStatement
///       spawn-statement:
///         'spawn' identifier statement
StmtResult Parser::ParseKitsuneSpawnStatement() {
...
StmtResult Parser::ParseKitsuneForallStatement(SourceLocation *TrailingElseLoc) {
  ...
  return Actions.ActOnKitsuneForallStmt(ForLoc, T.getOpenLocation(), FirstPart.get(),
